...
export GATEWAY_IMAGE_TAG="${GATEWAY_TAG:-20260401-105548}"
export SCHEDULER_IMAGE_TAG="${SCHEDULER_TAG:-20260401-105706}"
export VLLM_IMAGE_TAG="${VLLM_TAG:-20260306-165123}"
export DISCOVERY_IMAGE_TAG="${DISCOVERY_TAG:-20260323-142758}"
