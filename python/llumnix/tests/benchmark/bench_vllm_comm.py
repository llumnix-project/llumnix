...
class BenchmarkConfig:
    ...
    dst_port: int = 29876
    src_llumlet_host: str = ""
    src_llumlet_port: int = 1234
...
def parse_args() -> BenchmarkConfig:
    ...
    parser.add_argument("--num-mig", type=int, default=1)
...
class LlumletClient:
    ...
    async def send_migrate(self, src, dst, num_mig):
        ...
        request = llumlet_server_pb2.MigrateRequest(
            ...
            dst_engine_ip=dst.llumlet_host,
            dst_engine_port=dst.llumlet_port,
        ...
        while not stop_event.is_set():
            try:
                ...
                if grpc_client:
                    ...
                    await grpc_client.send_migrate(src, dst, num_mig)
