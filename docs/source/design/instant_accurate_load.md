...
**Goal**: provide a **r**eal**t**ime and **a**ccurate **l**oad basis (**Ial**) for LLM scheduling, covering both (i) how instance load status is observed and (ii) how prefill and decode compute load are modeled for decisions.
