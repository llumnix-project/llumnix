...
For detailed design information, please refer to the [Gateway Architecture Design Document](../design/gateway/gateway_architecture.md) and [Batch Inference Design](../design/gateway/batch_inference.md).
