		...
		"instance-neutral-3": {
			cmsView: &cms.InstanceView{
				...
				Status: &cms.InstanceStatus{
					...
					NumTotalGpuBlocks:                     100,
					NumUsedGpuBlocks:                      50,
					NumUncomputedBlocksAllWaitingPrefills: 2,
					Schedulable:                           false,
					TimestampMs:                           time.Now().UnixMilli(),
				},
				Metadata: &cms.InstanceMetadata{
		...
		"instance-neutral-4": {
			cmsView: &cms.InstanceView{
				...
				Status: &cms.InstanceStatus{
					...
					NumTotalGpuBlocks:                     100,
					NumUsedGpuBlocks:                      50,
					NumUncomputedBlocksAllWaitingPrefills: 1,
					Schedulable:                           true,
					TimestampMs:                           0,
				},
				Metadata: &cms.InstanceMetadata{
		...
		"instance-decode-6": {
			cmsView: &cms.InstanceView{
				...
				Status: &cms.InstanceStatus{
					...
					NumTotalGpuBlocks:                     100,
					NumUsedGpuBlocks:                      50,
					NumUncomputedBlocksAllWaitingPrefills: 60,
					Schedulable:                           true,
					TimestampMs:                           time.Now().UnixMilli(),
				},
				Metadata: &cms.InstanceMetadata{
		...
		"instance-decode-x": {
			cmsView: &cms.InstanceView{
				...
				Status: &cms.InstanceStatus{
					...
					NumTotalGpuBlocks:                     100,
					NumUsedGpuBlocks:                      50,
					NumUncomputedBlocksAllWaitingPrefills: 5,
					Schedulable:                           true,
					TimestampMs:                           time.Now().UnixMilli(),
				},
				Metadata: &cms.InstanceMetadata{
		...
		"instance-decode-5": {
			cmsView: &cms.InstanceView{
				...
				Status: &cms.InstanceStatus{
					...
					NumTotalGpuBlocks:                     100,
					NumUsedGpuBlocks:                      50,
					NumUncomputedBlocksAllWaitingPrefills: 110,
					SchedulerRunningToDecodeRequestsNum:   3,
					Schedulable:                           true,
					TimestampMs:                           time.Now().UnixMilli(),
				},
		...
		"instance-decode-x1": {
			cmsView: &cms.InstanceView{
				...
				Status: &cms.InstanceStatus{
					...
					NumTotalGpuBlocks:                     100,
					NumUsedGpuBlocks:                      50,
					NumUncomputedBlocksAllWaitingPrefills: 200,
					SchedulerRunningToDecodeRequestsNum:   3,
					Schedulable:                           true,
					TimestampMs:                           time.Now().UnixMilli(),
				},
