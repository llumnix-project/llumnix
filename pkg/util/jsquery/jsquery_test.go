...
// import (
// 	"easgo/pkg/sysdef/consts"
// 	"encoding/json"
// 	"errors"
// 	"fmt"
// 	"github.com/wI2L/jsondiff"
// 	legacyv1 "gitlab.alibaba-inc.com/eas/client-go/apis/legacy/v1"
// 	"reflect"
// 	"sort"
// 	"strings"
// 	"testing"
...
// 	equal, err := CompareExp(jq1, jq2, consts.ServiceKeyGateway)
// 	if err != nil {
// 		t.Fatal(err)
// 	}
...
// 	equal, err := CompareExps(jq1, jq2, []string{consts.ServiceKeyGateway})
// 	if err != nil {
// 		t.Fatal(err)
// 	}
...
// func TestJsonDiff2(t *testing.T) {
// 	spec1 := legacyv1.ServiceSpec{}
// 	spec1.Config = "a"
// 	spec1.Gateway = "contour"
// 	spec1.Nodes = []legacyv1.ServiceNode{
// 		{
// 			GPU:    1,
// 			Weight: 1,
// 		},
...
// 	spec2 := legacyv1.ServiceSpec{}
// 	spec2.Config = "b"
// 	spec2.Gateway = "shard0"
// 	spec2.Nodes = []legacyv1.ServiceNode{
// 		{
// 			GPU:    1,
// 			Weight: 2,
// 		},
...
// 	patch, err := jsondiff.Compare(spec1, spec2)
// 	if err != nil {
// 		t.Fatal(err)
// 	}
...
// 		t.Log(change.Path, change.Type, change.OldValue, change.Value)
// 	}
// }

// func TestJsonDiff3(t *testing.T) {
// 	spec := legacyv1.ServiceSpec{}
// 	spec.Gateway = "contour"
// 	spec.Nodes = []legacyv1.ServiceNode{
// 		{
// 			GPU:    1,
// 			Weight: 1,
// 		},
...
// 	patch, err := jsondiff.Compare(nil, spec)
// 	if err != nil {
// 		t.Fatal(err)
// 	}
...
// func TestJsonDiff4(t *testing.T) {
// 	spec1 := legacyv1.ServiceSpec{}
// 	spec1.Domains = []string{"a.com"}

// 	spec2 := legacyv1.ServiceSpec{}
// 	spec2.Domains = []string{"b.com"}
